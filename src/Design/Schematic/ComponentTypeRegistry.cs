...
public static class ComponentTypeRegistry
{
    ...
    /// (<see cref="CircuitRF.Design.Layout.PCells.SubstrateResolver"/>) and its OVERRIDE plumbing already
    /// present (<see cref="CircuitRF.Design.Layout.PCells.PCellLayerSelection"/>,
